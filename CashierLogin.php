...
$password=$_POST['password'];
 ...
 $usernameSearch= mysqli_query($con,"select username from cashier where username='$username'");
 $passwordSearch=mysqli_query($con,"select password from cashier where password='$password'");
...
if($usernameFound>0 && $passwordFound>0)
{
	...
	header("refresh:1,url='CashierPortal.php'");
}
}
